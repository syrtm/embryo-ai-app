        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block">Advanced Embryo Grading</span>
              <span className="block text-red-600">Powered by AI</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Experience the future of IVF treatment with our cutting-edge AI technology. 
              Providing accurate embryo grading and personalized treatment plans.
            </p>
                ...
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-500">
                      Advanced machine learning algorithms provide accurate and consistent embryo grading.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-500">
                      Get instant embryo grading results and recommendations from our AI system.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Patient Dashboard</h3>
                    <p className="mt-5 text-base text-gray-500">
                      Track your treatment progress and view analysis results in a user-friendly interface.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-red-50">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <span className="block text-red-600">Join us today and experience the difference.</span>
          </h2>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base text-gray-400">
              &copy; 2025 AI IVF Care. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
